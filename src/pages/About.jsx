...
const CORE_PRINCIPLES = [
  ...
  {
    title: 'Ish oqimi intizomi',
    text: 'Ariza, chat, jadval va case holati advokat kabinetida bitta oqimga birlashtirilgan.',
    icon: FileCheck2,
  },
  {
    title: 'Maxfiylik standarti',
    text: 'Mijoz ma\'lumotlari va yozishmalar ruxsatga asoslangan yopiq oqimda saqlanadi.',
    icon: LockKeyhole,
  },
  {
    title: 'Natijaga yo\'naltirilgan yondashuv',
    text: 'Maqsad faqat javob yozish emas, amaliy yakun va huquqiy natijaga chiqishdir.',
    icon: Handshake,
  },
];
...
const WORKFLOW = [
  {
    title: '01. Murojaat qabul qilish',
    text: 'Mijoz murojaati advokat oqimiga tushadi va ustuvorlik bo\'yicha saralanadi.',
  },
  {
    title: '02. Dastlabki tahlil',
    text: 'Huquqiy risk, hujjatlar holati va keyingi qadamlar aniq belgilanadi.',
  },
  {
    title: '03. Jonli muloqot',
    text: 'Support yoki to\'g\'ridan-to\'g\'ri suhbatda masala bo\'yicha amaliy strategiya beriladi.',
  },
  {
    title: '04. Yopilish va hisobot',
    text: 'Case holati yangilanadi, natija qayd etiladi va tarix saqlanadi.',
  },
];
            ...
            <div className="relative grid lg:grid-cols-[1.2fr_0.8fr] gap-6 p-6 md:p-9">
              <div>
                <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/15 border border-white/25 text-xs font-semibold tracking-wide">
                  <ShieldCheck size={14} />
                  LegalLink Lawyer Portal
                </span>
                <h1 className="mt-4 text-3xl md:text-5xl font-serif font-bold leading-tight">
                  Advokatlar uchun
                  <br />
                  real ish boshqaruvi markazi
                </h1>
                <p className="mt-4 text-slate-100 max-w-2xl leading-relaxed">
                  Portal advokatlar ishini tizimlashtiradi: case oqimi, suhbatlar, jadval va hisobotlar yagona
                  interfeysda boshqariladi.
                </p>

                <div className="mt-6 flex flex-wrap gap-2.5">
                  <Link to="/lawyer">
                    <Button className="h-11 px-6 text-sm">Kabinetga kirish</Button>
                  </Link>
          ...
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-4">
            <div className="surface-card rounded-3xl p-5 md:p-6">
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                Dizayn yengil, ichki model aniq: javobgarlik, muddat va natija metrikalari doimiy nazoratda.
              </p>
            ...
            <div className="surface-card rounded-3xl p-5 md:p-6">
              ...
              <h3 className="mt-2 text-2xl font-serif font-bold text-slate-900 dark:text-white">Portal qanday ishlaydi</h3>
      ...
      <section className="pb-10 md:pb-16">
        <div className="section-wrap">
          <div className="surface-card rounded-3xl p-5 md:p-6">
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              Advokatlar jamoasi uchun markazlashgan aloqa va case nazorati ishlaydi. Har bir ish bo\'yicha status,
              muddat va asosiy yozishmalar tizimda qayd etiladi.
            </p>

            <ul className="mt-4 space-y-2 text-sm text-slate-700 dark:text-slate-200">
              <li className="inline-flex items-start gap-2"><Building2 size={15} className="mt-0.5 text-[var(--color-primary)]" /> Markaziy koordinatsiya va yuristlar navbati</li>
              <li className="inline-flex items-start gap-2"><MapPinned size={15} className="mt-0.5 text-[var(--color-primary)]" /> Toshkent va viloyatlar kesimida xizmat</li>
            ...
            <div className="mt-5 flex flex-wrap gap-2.5">
              <Link to="/auth">
                <Button className="h-11 px-6 text-sm">Kirish</Button>
              </Link>
              <Link to="/lawyer">
                <Button variant="outline" className="h-11 px-6 text-sm">Kabinet</Button>
              </Link>
            </div>
          </div>
        </div>
